...
class ShowProfileFragment : Fragment(R.layout.fragment_show_profile) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fullNameTV = view.findViewById<TextView>(R.id.fullNameTV)
        nicknameTV = view.findViewById<TextView>(R.id.nicknameTV)
        emailTV = view.findViewById<TextView>(R.id.emailTV)
        locationTV = view.findViewById<TextView>(R.id.locationTV)
        phonenumberTV = view.findViewById<TextView>(R.id.phonenumberTV)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when(item.itemId){
            R.id.editButton -> {
                val bundle = bundleOf("fullname" to fullNameTV.text.toString(),
